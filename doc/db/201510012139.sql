...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='明星表';
...
INSERT INTO `qimei_actor` VALUES (1,'钟汉良','钟汉良',NULL,NULL,'1974年11月30日出生于中国香港，影视演员、歌手、舞者','2015-10-01 09:19:38'),(2,'唐嫣','唐嫣',NULL,NULL,'1983年12月6日出生于上海，中国女演员','2015-10-01 09:19:38'),(3,'陈赫','陈赫',NULL,NULL,'1985年11月9日出生于福建长乐，中国大陆男演员。毕业于上海戏剧学院表演系，上海话剧艺术中心演员','2015-10-01 09:19:39'),(4,'娄艺潇','娄艺潇',NULL,NULL,'1988年12月27日出生于辽宁省大连市，中国女演员。毕业于上海戏剧学院表演系','2015-10-01 09:19:39'),(5,'孙艺洲','孙艺洲',NULL,NULL,'1983年10月23日出生于四川成都，上海话剧艺术中心话剧演员','2015-10-01 09:19:39'),(6,'李金铭','李金铭',NULL,NULL,'1985年11月21日出生于山东济南章丘，中国女演员、主持人','2015-10-01 09:19:40'),(7,'刘亦菲','刘亦菲','NO_AVATAR_YET','NO_BACKGROUND_YET','我是刘亦菲，我就是小仙女','2015-09-30 22:23:23'),(8,'黄晓明','黄晓明','NO_AVATAR_YET','NO_BACKGROUND_YET','闹太套就是我','2015-09-30 23:19:20');
...
CREATE TABLE `qimei_link_actor_movie` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='演员和影视的多对多关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qimei_link_actor_movie` VALUES (1,1,1,'2015-10-01 10:21:07','何以琛'),(2,2,1,'2015-10-01 10:21:07','赵默笙'),(3,3,2,'2015-10-01 10:21:07','曾小贤'),(4,4,2,'2015-10-01 10:21:07','胡一菲'),(5,5,2,'2015-10-01 10:21:07','吕子乔'),(6,6,2,'2015-10-01 10:21:08','陈美嘉'),(7,7,3,'2015-10-01 12:18:45','小龙女'),(8,7,4,'2015-10-01 12:18:45','赵灵儿'),(9,8,3,'2015-10-01 12:18:45','杨过');
...
INSERT INTO `qimei_link_actor_poster` VALUES (1,1,1,'2015-10-01 13:19:11'),(2,1,2,'2015-10-01 13:19:11'),(3,2,1,'2015-10-01 13:21:25');
...
CREATE TABLE `qimei_poster` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='剧照';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qimei_poster` VALUES (1,'/img','1',80,'2015-10-01 12:35:01'),(2,'NO_IMG_YET','1',90,'2015-10-01 13:21:57');
...
INSERT INTO `qimei_touch` VALUES (1,1,8,29,'??','http://www.localhost:8080/index.html','2015-10-01 12:34:32');
...
-- Dump completed on 2015-10-01 21:39:18
